...
def get_lumharel_date():
    ...
    return mois_nom, jour_mois, jour_semaine, phase_astraelis, phase_vorna, festivite_du_jour
...
async def calendrier(ctx):
    ...
    mois, jour_mois, jour_semaine, phase_astraelis, phase_vorna, festivite = get_lumharel_date()
